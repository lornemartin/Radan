    ...
    public partial class Form1 : RibbonForm
    {
        ...
        private bool masterItemToRadanPart(OrderItem oItem)
        {
            try
            {
                ...
                if (rPrj.Parts != null)
                {
                    ...
                    if (matchFound)
                    {
                        MessageBox.Show(Path.GetFileName(symName) + " already exists in this radan project, a new entry will be created.");
                    }
        ...
        private bool RadanPartToMasterItem(RadanPart radPart)
        {
            try
            {
                ...
                List<OrderItem> masterItemList = dbContext.OrderItems.Where(i => i.Part.FileName == symName).ToList();
