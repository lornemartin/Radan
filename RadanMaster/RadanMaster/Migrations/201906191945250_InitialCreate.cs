namespace RadanMaster.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        OperationPerformed_ID = c.Int(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.OrderItemOperations", t => t.OrderItemOperation_ID)
                .ForeignKey("dbo.OperationPerformeds", t => t.OperationPerformed_ID)
                .Index(t => t.OrderItemOperation_ID)
                .Index(t => t.OperationPerformed_ID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OrderItemOperationPerformeds", "OperationPerformed_ID", "dbo.OperationPerformeds");
            ...
            DropIndex("dbo.OrderItemOperationPerformeds", new[] { "OperationPerformed_ID" });
